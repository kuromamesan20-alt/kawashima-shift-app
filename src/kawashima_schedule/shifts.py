...
#   8-15時 と 9-16時 を削除し、9-15時 に一本化(2026年9月)
#     どちらもスタッフカードの「日勤または時短9-16時、8-15時など」という
#     例示から作ったものだが、実際に使われていたのは 9-15時 だった。
#     9-15時 は複数の方の条件欄に出てくる(「毎週月曜日は9-15時」など)。
HOUR_CHOICES: Tuple[str, ...] = ("9-13時", "13-17時", "9-15時")
